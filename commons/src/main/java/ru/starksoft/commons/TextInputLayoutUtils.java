...
public final class TextInputLayoutUtils {
	...
	public static boolean setErrorWithValidation(@NonNull TextInputLayout textInputLayout, String text, String errorText,
	...
	public static boolean setErrorWithValidation(@NonNull TextInputLayout textInputLayout, String text, String errorText, boolean condition,
	...
	public static class Validator {
		...
		public boolean validate(TextInputLayout textInputLayout, boolean condition) {
			return setErrorWithValidation(textInputLayout, getEditTextTextSafe(textInputLayout).trim(), emptyText, condition, errorMessage);
		}
	}
}
