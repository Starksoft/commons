...
public class AbstractLoggerTest {
	...
	public void replaceSinglePlaceholder() {
		...
		result = replaceLogPlaceholders("proceedOrderIfSplitPayment(): Error sending order={}, e={}", () -> Arrays.asList(
		...
		assertEquals("proceedOrderIfSplitPayment(): Error sending order=Возникла неизвестная ошибка в процессе отправки заказа, e=android.os.NetworkOnMainThreadException\n" +
							 "\tat android.os.StrictMode$AndroidBlockGuardPolicy.onNetwork(StrictMode.java:1605)\n" +
							 "\tat java.net.SocketOutputStream.socketWrite(SocketOutputStream.java:116)\n" +
							 "\tat java.net.SocketOutputStream.write(SocketOutputStream.java:161)\n" +
							 "\tat okio.OutputStreamSink.write(JvmOkio.kt:53)", result);
	}
